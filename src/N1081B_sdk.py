...
class N1081B:
    ...
    def connect(self):
        self.ws = create_connection(self.API_ENDPOINT)
    ...
    def set_section_function(self, section, function):
        ...
        if self.ws.connected:
            self.ws.send('{"command":"select_section_function", "callback":"set_fn", "params":{"section":'
    ...
    def get_sections_function(self):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"get_all_sections_function", "callback":"get_fn"}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
    ...
    def __config_logic4(self, section, function, enable0, enable1, enable2, enable3):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"configure_function", "callback":"' + function + '", "params":{"section":'
    ...
    def configure_lut(self, section, i_enable0, i_enable1, i_enable2, i_enable3, i_enable4, i_enable5, o_enable0,
        ...
        if self.ws.connected:
            if file_mode == self.FileMode.FILE_EXISTING:
                self.ws.send('{"command":"configure_function", "callback":"lut_old", "params":{"section":' + self.__int_to_str(section.value)
            ...
            if file_mode == self.FileMode.FILE_NEW:
                self.ws.send('{"command":"configure_function", "callback":"lut_new", "params":{"section":' + self.__int_to_str(section.value)
                        + ', "lemo_out_enables":[{"lemo":0, "enable":' + self.__bool_to_str(o_enable0)
                        + '}, {"lemo":1, "enable":' + self.__bool_to_str(o_enable1) + '}, {"lemo":2, "enable":'
                        + self.__bool_to_str(o_enable2) + '}, {"lemo":3, "enable":' + self.__bool_to_str(o_enable3)
                        + '}], "lemo_in_enables":[{"lemo":0, "enable":' + self.__bool_to_str(i_enable0) + '}, {"lemo":1, "enable":'
    ...
    def configure_coincidence_gate(self, section, enable0, enable1, enable2, enable3, enable4, coinc0, coinc1, coinc2,
        ...
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"configure_function", "callback":"coincidence", "params":{"section":'
                    + self.__int_to_str(section.value) + ', "lemo_enables":[{"lemo":0, "enable":' + self.__bool_to_str(enable0)
    ...
    def configure_scaler(self, section, scale, enable0, enable1, enable2, enable3, enable_gate):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"configure_function", "callback":"scaler", "params":{"section":' + self.__int_to_str(section.value)
    ...
    def configure_counter(self, section, enable0, enable1, enable2, enable3, enable_gate):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"configure_function", "callback":"counter", "params":{"section":' + self.__int_to_str(section.value)
    ...
    def configure_counter_timer(self, section, enable0, enable1, enable_gate, auto_reset, gate1_width, gate2_width,
        ...
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"configure_function", "callback":"counter_timer", "params": {"section":' + self.__int_to_str(section.value)
                    + ', "lemo_enables":[{"lemo":0, "enable":' + self.__bool_to_str(enable0) + '}, {"lemo":1, "enable":'
    ...
    def configure_chronometer(self, section, frequency, chronometer_mode, enable0, enable1, enable_gate, reset_on_gate, reset_on_stop):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"configure_function", "callback":"chronometer", "params":{"section":' + self.__int_to_str(section.value)
    ...
    def configure_rate_meter(self, section, enable0, enable1, enable2, enable3, enable_gate):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"configure_function", "callback":"rate_meter", "params":{"section":' + self.__int_to_str(section.value)
                    + ', "lemo_enables":[{"lemo":0, "enable":' + self.__bool_to_str(enable0) + '}, {"lemo":1, "enable":'
                    + self.__bool_to_str(enable1) + '}, {"lemo":2, "enable":' + self.__bool_to_str(enable2)
                    + '}, {"lemo":3, "enable":' + self.__bool_to_str(enable3) + '}], "gate":' + self.__bool_to_str(enable_gate) + '}}')
            r = self.ws.recv()
    ...
    def configure_rate_meter_advanced(self, section, enable0, enable1, enable2, enable3, enable_gate, enable_alarm,
        ...
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"configure_function", "callback":"rate_meter_advanced", "params":{"section":' + self.__int_to_str(section.value)
                    + ', "lemo_enables":[{"lemo":0, "enable":' + self.__bool_to_str(enable0) + '}, {"lemo":1, "enable":'
                    + self.__bool_to_str(enable1) + '}, {"lemo":2, "enable":' + self.__bool_to_str(enable2)
    ...
    def configure_time_tagging(self, section, enable0, enable1, enable2, enable3, enable4, enable5):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"configure_function", "callback":"time_tagging", "params":{"section":' + self.__int_to_str(section.value)
                    + ', "lemo_enables":[{"lemo":0, "enable":' + self.__bool_to_str(enable0) + '}, {"lemo":1, "enable":'
                    + self.__bool_to_str(enable1) + '}, {"lemo":2, "enable":' + self.__bool_to_str(enable2)
    ...
    def configure_time_of_flight(self, section, enable0, enable1, enable3, enable4, windows_mode, windows_value, windows_number,
        ...
        if self.ws.connected:
            if windows_mode == self.WindowsMode.WINDOWS_FIXED:
                self.ws.send('{"command":"configure_function", "callback":"time_of_flight", "params":{"section":' + self.__int_to_str(section.value)
                        + ', "lemo_enables":[{"lemo":0, "enable":' + self.__bool_to_str(enable0) + '}, {"lemo":1, "enable":'
    ...
    def configure_time_over_threshold(self, section, enable0, enable1, enable3, enable4, windows_value, windows_number):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"configure_function", "callback":"time_over_threshold", "params":{"section":' + self.__int_to_str(section.value)
                    + ', "lemo_enables":[{"lemo":0, "enable":' + self.__bool_to_str(enable0) + '}, {"lemo":1, "enable":'
                    + self.__bool_to_str(enable1) + '}, {"lemo":2, "enable":true}, {"lemo":3, "enable":' + self.__bool_to_str(enable3)
                    + '}, {"lemo":4, "enable":' + self.__bool_to_str(enable4) + '}, {"lemo":5, "enable":true}], "win_mode":0'
                    + ', "win_value":' + self.__int_to_str(windows_value) + ', "win_number":' + self.__int_to_str(windows_number) + '}}')
    ...
    def configure_digital_generator(self, section, enable0, enable1, enable2, enable3):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"configure_function", "callback":"digital_generator", "params":{"section":' + self.__int_to_str(section.value)
                    + ', "lemo_enables":[{"lemo":0, "enable":' + self.__bool_to_str(enable0) + '}, {"lemo":1, "enable":'
                    + self.__bool_to_str(enable1) + '}, {"lemo":2, "enable":' + self.__bool_to_str(enable2)
                    + '}, {"lemo":3, "enable":' + self.__bool_to_str(enable3) + '}]}}')
            r = self.ws.recv()
    ...
    def configure_pattern_generator(self, section, enable0, enable1, enable2, enable3, frequency,
        ...
        if self.ws.connected:
            if file_mode == self.FileMode.FILE_EXISTING:
                self.ws.send('{"command":"configure_function", "callback":"pattern_generator", "params":{"section":'
                        + self.__int_to_str(section.value) + ', "lemo_enables":[{"lemo":0, "enable":' + self.__bool_to_str(enable0)
                        + '}, {"lemo":1, "enable":' + self.__bool_to_str(enable1) + '}, {"lemo":2, "enable":'
                        + self.__bool_to_str(enable2) + '}, {"lemo":3, "enable":' + self.__bool_to_str(enable3)
                        + '}], "frequency":' + self.__int_to_str(frequency) + ', "file_mode":0, "file_name":"' + file_name + '"}}')
            if file_mode == self.FileMode.FILE_NEW:
                self.ws.send('{"command":"configure_function", "callback":"pattern_generator_new", "params":{"section":'
                        + self.__int_to_str(section.value) + ', "lemo_enables":[{"lemo":0, "enable":' + self.__bool_to_str(enable0)
                        + '}, {"lemo":1, "enable":' + self.__bool_to_str(enable1) + '}, {"lemo":2, "enable":'
                        + self.__bool_to_str(enable2) + '}, {"lemo":3, "enable":' + self.__bool_to_str(enable3)
    ...
    def get_function_configuration(self, section):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"get_function_config", "callback":"get_config", "params":{"section":' + self.__int_to_str(section.value) + '}}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
    ...
    def get_function_results(self, section):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"get_function_results", "callback":"get_results", "params":{"section":' + self.__int_to_str(section.value) + '}}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
    ...
    def reset_channel(self, section, channel, function):
        ...
        if self.ws.connected:
            if function == self.FunctionType.FN_CHRONOMETER or function == self.FunctionType.FN_COUNTER or function == self.FunctionType.FN_COUNTER_TIMER or function == self.FunctionType.FN_RATE_METER_ADVANCED or function == self.FunctionType.FN_SCALER:
                self.ws.send('{"command":"reset_channel", "callback":"reset_ch", "params":{"section":' + self.__int_to_str(section.value)
                        + ', "channel":' + self.__int_to_str(channel) + '}}')
            else:
                if function == self.FunctionType.FN_COINCIDENCE_GATE:
                    self.ws.send('{"command":"reset_channel", "callback":"reset_ch", "params":{"section":' + self.__int_to_str(section.value) + ', "channel":0}}')
                else:
                    if function == self.FunctionType.FN_TIME_OF_FLIGHT or function == self.FunctionType.FN_TIME_OVER_THRESHOLD:
                        self.ws.send('{"command":"reset_channel", "callback":"reset_ch", "params":{"section":' + self.__int_to_str(section.value) + ', "channel":2}}')
                    else:
                        return "{}"
    ...
    def start_acquisition(self, section, function):
        ...
        if self.ws.connected:
            if function == self.FunctionType.FN_LUT or function == self.FunctionType.FN_PATTERN_GENERATOR or function == self.FunctionType.FN_TIME_OF_FLIGHT or function == self.FunctionType.FN_TIME_OVER_THRESHOLD:
                self.ws.send('{"command":"reset_channel", "callback":"start", "params":{"section":' + self.__int_to_str(section.value) + ', "channel":1}}')
            else:
                if function == self.FunctionType.FN_TIME_TAG:
                    self.ws.send('{"command":"reset_channel", "callback":"start", "params":{"section":' + self.__int_to_str(section.value) + ', "channel":1}}')
                    self.ws.send('{"command":"start_tt_data", "callback":"start", "params":{"section":' + self.__int_to_str(section.value) + '}}')
                else:
                    return "{}"
            r = self.ws.recv()
            #self.ws.close()
    ...
    def stop_acquisition(self, section, function):
        ...
        if self.ws.connected:
            if function == self.FunctionType.FN_LUT or function == self.FunctionType.FN_PATTERN_GENERATOR or function == self.FunctionType.FN_TIME_OF_FLIGHT or function == self.FunctionType.FN_TIME_OVER_THRESHOLD:
                self.ws.send('{"command":"reset_channel", "callback":"stop", "params":{"section":' + self.__int_to_str(section.value) + ', "channel":0}}')
            else:
                if function == self.FunctionType.FN_TIME_TAG:
                    self.ws.send('{"command":"reset_channel", "callback":"stop", "params":{"section":' + self.__int_to_str(section.value) + ', "channel":0}}')
                    self.ws.send('{"command":"stop_tt_data", "callback":"stop", "params":{"section":' + self.__int_to_str(section.value) + '}}')
                else:
                    return "{}"
            r = self.ws.recv()
            #self.ws.close()
    ...
    def get_function_file_list(self, function):
        ...
        if self.ws.connected:
            if function == self.FunctionType.FN_LUT:
                self.ws.send('{"command":"get_config_file", "callback":"get_file", "function":"lut"}')
            if function == self.FunctionType.FN_PATTERN_GENERATOR:
                self.ws.send('{"command":"get_config_file", "callback":"get_file", "function":"pattern"}')
            if function == self.FunctionType.FN_TIME_OF_FLIGHT:
                self.ws.send('{"command":"get_config_file", "callback":"get_file", "function":"width"}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
    ...
    def download_function_file(self, function, file_name):
        ...
        if self.ws.connected:
            if function == self.FunctionType.FN_LUT:
                self.ws.send('{"command":"download_config", "callback":"download_file", "params":{"file_name":"' + file_name + '", "function":"lut"}}')
            if function == self.FunctionType.FN_PATTERN_GENERATOR:
                self.ws.send('{"command":"download_config", "callback":"download_file", "params":{"file_name":"' + file_name + '", "function":"pattern"}}')
            if function == self.FunctionType.FN_TIME_OF_FLIGHT:
                self.ws.send('{"command":"download_config", "callback":"download_file", "params":{"file_name":"' + file_name + '", "function":"width"}}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
    ...
    def delete_function_file(self, function, file_name):
        ...
        if self.ws.connected:
            if function == self.FunctionType.FN_LUT:
                self.ws.send('{"command":"delete_config", "callback":"delete_file", "params":{"file_name":"' + file_name + '", "function":"lut"}}')
            if function == self.FunctionType.FN_PATTERN_GENERATOR:
                self.ws.send('{"command":"delete_config", "callback":"delete_file", "params":{"file_name":"' + file_name + '", "function":"pattern"}}')
            if function == self.FunctionType.FN_TIME_OF_FLIGHT:
                self.ws.send('{"command":"delete_config", "callback":"delete_file", "params":{"file_name":"' + file_name + '", "function":"width"}}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)

    def set_input_configuration(self, section, standard, standard_special, threshold, impedance):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"configure_input", "callback":"input_cfg", "params":{'
                    '"section":' + self.__int_to_str(section.value)
                    + ', "standard":' + self.__int_to_str(standard.value)
                    + ', "standard_sub":' + self.__int_to_str(standard_special.value)
                    + ', "threshold":' + self.__int_to_str(threshold)
                    + ', "imp":' + impedance.value + '}}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
    ...
    def get_input_configuration(self, section):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"get_input_config", "callback":"get_input_config", "params":{"section":' + self.__int_to_str(section.value) + '}}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
    ...
    def set_input_channel_configuration(self, section, channel, status, enable_gate_delay, gate, delay, invert):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"configure_input_channel", "callback":"set_input_ch_config", "params":{"section":' + self.__int_to_str(section.value)
    ...
    def get_input_channel_configuration(self, section, channel):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"get_input_channel_config", "callback":"get_input_ch_config", "params":{"section":'
                    + self.__int_to_str(section.value) + ', "channel":' + self.__int_to_str(channel) + '}}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)

    def set_output_configuration(self, section, standard):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"configure_output", "callback":"output_cfg", "params":{"section":' + self.__int_to_str(section.value)
                    + ', "standard":' + self.__int_to_str(standard.value) + ', "imp":"false"}}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
    ...
    def get_output_configuration(self, section):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"get_output_config", "callback":"get_output_config", "params":{"section":' + self.__int_to_str(section.value) + '}}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
    ...
    def set_output_channel_configuration(self, section, channel, status, enable_monostable, monostable, invert):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"configure_output_channel", "callback":"set_output_ch_config", "params":{"section":'
    ...
    def get_output_channel_configuration(self, section, channel):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"get_output_channel_config", "callback":"get_output_ch_config", "params":{"section":'
                    + self.__int_to_str(section.value) + ', "channel":' + self.__int_to_str(channel) + '}}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
    ...
    def start_logic_analyzer(self):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"la_arm", "callback":"logic_analyzer"}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
    ...
    def set_logic_analyzer_trigger(self, trigger_mode_in, trigger_mode_out, edge, sec1_in1, sec1_in2, sec1_in3, sec1_in4, sec1_in5, sec1_in6,
        ...
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            trig_str = ('{"command":"configure_la_trigger", "callback":"logic_analyzer", "params":{"file_content":"' + ('{"mode_in":'
                ...
                + ', "sec4_out4":' + self.__bool_to_str(sec4_out4) + '}').replace('"', '\\"') + '"}}')
            self.ws.send(trig_str)
    ...
    def get_logic_analyzer_trigger(self):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"get_la_trigger_config", "callback":"logic_analyzer"}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
    ...
    def get_logic_analyzer_data(self):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"la_getdata", "callback":"logic_analyzer"}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)

    def get_time_tag_data(self):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            r = self.ws.recv()
            #self.ws.close()
            j = json.loads(r.replace(",]", "]"))
            if j["command"] == "send_data":
                return j["timetag_data"]
            else:
                return []
    ...
    def set_ethernet_configuration(self, dhcp, ip, netmask, gateway, dns):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"set_eth_config", "callback":"ethernet_config", "data":{"dhcp":' + self.__int_to_str(dhcp)
    ...
    def get_ethernet_configuration(self):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"get_eth_config", "callback":"ethernet_config"}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
    ...
    def get_configuration_file_list(self):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"get_config_file", "callback":"get_cfg_file", "function":"config"}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
    ...
    def save_configuration_file(self, file_name):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"create_config", "callback":"save_cfg_file", "params":{"new_name":"' + file_name + '"}}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
    ...
    def load_configuration_file(self, file_name):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"load_config", "callback":"load_cfg_file", "params":{"file_name":"' + file_name + '"}}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
    ...
    def upload_configuration_file(self, file_name, file_content):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"upload_config", "callback":"upload_cfg_file", "params":{"file_name":"' + file_name
    ...
    def download_configuration_file(self, file_name):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"download_config", "callback":"download_cfg_file", "params":{"file_name":"' + file_name + '", "function":"config"}}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
    ...
    def delete_configuration_file(self, file_name):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"delete_config", "callback":"delete_cfg_file", "params":{"file_name":"' + file_name + '", "function":"config"}}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
    ...
    def rename_configuration_file(self, old_file_name, new_file_name):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"rename_config", "callback":"rename_cfg_file", "params":{"old_name":"' + old_file_name
    ...
    def start_search_device(self):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"start_alarm", "callback":"search_device"}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
    ...
    def stop_search_device(self):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"stop_alarm", "callback":"search_device"}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
    ...
    def get_search_device_status(self):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"get_alarm_status", "callback":"search_device"}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
    ...
    def check_clock(self):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"check_clk", "callback":"clock"}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
    ...
    def set_internal_clock(self):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"apply_int_clk", "callback":"clock"}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
    ...
    def set_external_clock(self):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"apply_ext_clk", "callback":"clock"}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
    ...
    def get_clock_status(self):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"get_clk_status", "callback":"clock"}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
    ...
    def get_version(self):
        #ws = create_connection(self.API_ENDPOINT)
        if self.ws.connected:
            self.ws.send('{"command":"get_version", "callback":"version"}')
            r = self.ws.recv()
            #self.ws.close()
            return json.loads(r)
